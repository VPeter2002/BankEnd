...
namespace AD41HN_HFT_2022231.Endpoint.Controllers
{
    [Route("[controller]")]
    [ApiController]
    public class OhioExerciseController : ControllerBase
    {
        IOhioExerciseLogic logic;
        IHubContext<SignalRHub> hub;

        public OhioExerciseController(IOhioExerciseLogic logic, IHubContext<SignalRHub> hub)
        {
            this.logic = logic;
            this.hub = hub;
        }
        ...
        [HttpPost]
        public void Create([FromBody] OhioExercise value)
        {
           
        }

        [HttpPut]
        public void Put([FromBody] OhioExercise value)
        {
            this.logic.Update(value);
            this.hub.Clients.All.SendAsync("OhioExercise", value);
        }
        ...
        public void Delete(int id)
        {
            ...
            this.hub.Clients.All.SendAsync("OhioExercise Deleted", playerToDelete);
        }
        //[HttpGet("{post}")]
